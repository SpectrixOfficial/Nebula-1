...
class MainCommands:
    ...
    async def invite(self, ctx):
        try:
            ...
            embed.add_field(name="Nebula's Invite", value=f"[Click Here](https://discordapp.com/oauth2/authorize?client_id={self.bot.user.id}&permissions=2146958591&scope=bot)")
